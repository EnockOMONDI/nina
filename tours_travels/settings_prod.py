...
CAREERS_MAX_FILE_SIZE_BYTES = int(os.getenv('CAREERS_MAX_FILE_SIZE_BYTES', CAREERS_MAX_FILE_SIZE_BYTES))
CAREERS_ALLOWED_EXTENSIONS = [
    ext.strip().lower()
    for ext in os.getenv('CAREERS_ALLOWED_EXTENSIONS', ",".join(CAREERS_ALLOWED_EXTENSIONS)).split(',')
    if ext.strip()
]
